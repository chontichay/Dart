...
import "package:meta/meta.dart"; //meta สามารถบังคับได้ ทำให้สามารถใช้ตัว required ได้
...
class GetValue {
  ...
  String getString(
      ...
      @required int? intMin,
      @required int? intMax}) {
    //using @required to unlock input order //required ทำให้ส่งค่าได้ สลับกันได้
    String? strValue;
    do {
