void main() {
  //use ? to allow variable can be null -- การจัดการค่า Null โดยการใช้เครื่องหมาย ? 1 ตัว ค่า Null คือค่าว่าง --> ?? คือยอมให้เป็นค่า Null ได้ กำหนดค่า Null--
  //use ?? (Null Coalescing Operator) to detect null then change to defined value
  String? strName;
  strName ??=
      "Somsri"; //if strName is null change it to "No Defined Name"
...
//function sumUpToFive will returned result (nteger) --ต้องการให้ฟังก์ชั่นคืนค่า
// a is required
